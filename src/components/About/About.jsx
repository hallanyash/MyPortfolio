  ...
  return (
    ...
    >
      <div className="text-center mb-10 px-4 py-5">
        ...
        <h3 className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-10 max-w-6xl mx-auto px-4 py-10">
        <div className="w-[550px] h-[550px] md:w-[450px] md:h-[450px] rounded-full bg-gradient-to-br from-[#667eea] via-[#764ba2] to-[#f093fb] p-[5px] shadow-lg">
